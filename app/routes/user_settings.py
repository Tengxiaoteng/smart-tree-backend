...
def _settings_to_response(settings: UserSettings) -> UserSettingsResponse:
    ...
    return UserSettingsResponse(
        ...
        useSystemKey=bool(use_system_override) if isinstance(use_system_override, bool) else False,
...
async def get_user_settings(
    ...
    try:
        ...
        return UserSettingsResponse(apiKey="", modelId="", baseUrl="", remember=False)
    if not settings:
        return UserSettingsResponse(apiKey="", modelId="", baseUrl="", remember=False)
