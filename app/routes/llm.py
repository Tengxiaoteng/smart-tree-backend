...
async def chat(
    ...
    # 自动路由：仅对特定 OpenAI 兼容服务生效
    should_route = routing == "auto" and "dashscope" in base_url
    if should_route:
    ...
    if use_system:
        ...
        for candidate in candidates:
            ...
            data["billing"] = {
                "mode": "system",
                "chargedPoints": int(actual_points or reserved_points),
